      ...
      <nav className="relative">
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-between">
              ...
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <Link
                    href="/"
                    className="text-white px-3 py-2 rounded-md text-base font-medium hover:bg-gray-400 hover:bg-opacity-15"
                  >
                    Home
                  </Link>
                  <Link
        ...
        {isOpen && (
          <div className="px-2 pt-2 pb-3 space-y-1 sm:hidden ">
            <Link
              href="/"
              className="text-white block px-3 py-2 rounded-md text-sm text-center font-medium hover:bg-gray-400 hover:bg-opacity-15"
            >
              Home
            </Link>
            <Link
